...
const DesktopDrawer = ({apodList, searchState, searchDispatch, handleSubmit}) => {
    ...
    return ( 
        ...
        <Box sx={{ display: 'flex' }}>
            ...
            >
                ...
                <form onSubmit={handleSubmit}>
                    <Stack
                        ...
                        sx={{mt: 2, mb: 4}}
                    >
                        <SelectField searchState={searchState} searchDispatch={searchDispatch} />
                        <InputField searchDispatch={searchDispatch} />
                        <Button 
                            variant="contained" 
                            color="success" 
                            type="submit" 
            ...
            > 
                <Toolbar />
                <ImageGallery items={apodList} handleOpen={handleOpen} />
